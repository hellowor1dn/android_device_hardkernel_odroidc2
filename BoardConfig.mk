...
#TARGET_BUILD_USER_PARTS := true
#BOARD_USER_PARTS_NAME := tvos info
#
#tvos_PART_TYPE := ext4
#tvos_PART_SIZE := 69206016
#tvos_PART_DIR := ./device/amlogic/p200/tvos
#
#info_PART_TYPE := ext4
#info_PART_SIZE := 79206016
#info_PART_DIR := ./device/amlogic/p200/info

TARGET_SUPPORT_USB_BURNING_V2 := true
TARGET_AMLOGIC_RES_PACKAGE := device/hardkernel/odroidc2/logo_img_files
